...
func (r *loadReader) ListApplications(context.Context) ([]usimcard.Application, error) {
...
func (r *loadReader) FileAttributes(_ context.Context, file usimcard.FileRef) (usimcard.FileAttributes, error) {
	...
	case "6F3E", "6F42", "7F106FE5":
		return usimcard.FileAttributes{}, errors.New("file not found")
	default:
		return usimcard.FileAttributes{}, errors.New("unexpected file")
	}
}

func (r *loadReader) ReadTransparent(_ context.Context, req usimcard.TransparentRead) ([]byte, error) {
...
func (r *loadReader) ReadRecord(_ context.Context, req usimcard.RecordRead) ([]byte, error) {
...
func (r *loadReader) Authenticate3G(context.Context, usimcard.AuthenticateRequest) ([]byte, error) {
	return nil, errors.New("unexpected authentication")
}

func (r *loadReader) SMSPPDownload(context.Context, usimcard.SMSPPDownloadRequest) (usimcard.SMSPPDownloadResponse, error) {
	return usimcard.SMSPPDownloadResponse{}, errors.New("unexpected SMS-PP download")
}

func transparentFile(size uint16) usimcard.FileAttributes {
...
func linearFixedFile(recordSize, recordCount uint16) usimcard.FileAttributes {
	return usimcard.FileAttributes{
...
func (r *akaFallbackReader) ListApplications(context.Context) ([]usimcard.Application, error) {
	return nil, errors.New("unexpected list applications")
}
func (r *akaFallbackReader) FileAttributes(context.Context, usimcard.FileRef) (usimcard.FileAttributes, error) {
	return usimcard.FileAttributes{}, errors.New("unexpected file attributes")
}
func (r *akaFallbackReader) ReadTransparent(context.Context, usimcard.TransparentRead) ([]byte, error) {
	return nil, errors.New("unexpected transparent read")
}
func (r *akaFallbackReader) ReadRecord(context.Context, usimcard.RecordRead) ([]byte, error) {
	return nil, errors.New("unexpected record read")
}
func (r *akaFallbackReader) Authenticate3G(_ context.Context, req usimcard.AuthenticateRequest) ([]byte, error) {
	switch {
...
func (r *akaFallbackReader) SMSPPDownload(context.Context, usimcard.SMSPPDownloadRequest) (usimcard.SMSPPDownloadResponse, error) {
	return usimcard.SMSPPDownloadResponse{}, errors.New("unexpected SMS-PP download")
}
